    ...
    for _, y in enumerate(range(0, 20)):
        for _, x in enumerate(range(0, 20)):
            ...
            if (x <= 16) and (y <= 16):
                ...
                second_column_equation: str = f"{_grid[x + 1][y]} * {_grid[x + 1][y  + 1]} * {_grid[x + 1][y + 2]} * {_grid[x + 1][y + 3]}"
                ...
                third_column_equation: str = f"{_grid[x + 2][y]} * {_grid[x + 2 ][y + 1]} * {_grid[x + 2][y + 2]} * {_grid[x + 2][y + 3]}"
                ...
                right_column_equation: str = f"{_grid[x + 3][y]} * {_grid[x + 3 ][y + 2]} * {_grid[x + 2][y + 2]} * {_grid[x + 2][y + 3]}"
                ...
                left_diagonal_equation: str = f"{_grid[x][y]} * {_grid[x + 1 ][y + 1]} * {_grid[x + 2][y + 2]} * {_grid[x + 3][y + 3]}"
                ...
                right_diagonal_equation: str = f"{_grid[x + 3][y]} * {_grid[x + 2 ][y + 1]} * {_grid[x + 1][y + 2]} * {_grid[x][y + 3]}"
